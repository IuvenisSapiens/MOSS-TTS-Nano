    ...
    def _load_reference_audio(self, reference_audio_path: str | Path) -> np.ndarray:
        ...
        try:
            ...
            if waveform.ndim == 1:
                ...
                raise ValueError(f"Unexpected audio data shape from soundfile: {waveform.shape}")
            ...
            try:
                ...
                raise RuntimeError(
                    ...
                    "Try using a WAV file or install FFmpeg / a torchcodec-compatible torchaudio build. "
                    f"soundfile error: {read_exc}; torchaudio error: {torchaudio_exc}"
                ) from torchaudio_exc
